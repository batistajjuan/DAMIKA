...
,(vd.DTV_CANTIDAD*vd.DTV_PRECIO_ORIGINAL)-(vd.DTV_PRECIO_ORIGINAL*((DTV_PORC_DSCTO/100))) +(((vd.DTV_CANTIDAD*vd.DTV_PRECIO_ORIGINAL)-((vd.DTV_CANTIDAD*vd.DTV_PRECIO_ORIGINAL)*(DTV_PORC_DSCTO/100)))*(VD.DTV_IVA/100))IMPORTE
